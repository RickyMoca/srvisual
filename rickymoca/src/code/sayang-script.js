function showDiv() {
    ...
    ket.style = "margin-top:10px";
}

function memulai() {
    suratin.style = "transition:all 1s ease;transform:scale(.2);opacity:0";
    ket.style = "transition:all 1s ease;transform:scale(0);opacity:0";
    setTimeout(pesan, 3000); // Untuk mengatur munculnya swal
}
...
function kpemb() {
    ...
    setTimeout(ngetik, 150); //Untuk atus duratsi muncul ketik
}
...
watermark.textContent = day + ", " + dateNum + " " + month + " " + year + " © Made With ♥ by Rickymoca";
watermark.style = "color:white;opacity:.7;font-size:14px;position:fixed; bottom:25px; margin:10px;";
